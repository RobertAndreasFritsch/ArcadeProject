...
public class TangiblePlayerBtn2Test
{
  ...
  @Test
  public void testAbsolutePlayerBtn2 ()
  {
    // GENERATE INPUT, UPDATE THE INTERFACE AND TEST
    PlayerControl.getKeyListener ().keyPressed (new KeyEvent (DUMMY, 0, currentTimeMillis (), 0, VK_E));
    PlayerControl.getKeyListener ().keyPressed (new KeyEvent (DUMMY, 0, currentTimeMillis (), 0, VK_Z));
    PlayerControl.getKeyListener ().keyPressed (new KeyEvent (DUMMY, 0, currentTimeMillis (), 0, VK_O));
    PlayerControl.getKeyListener ().keyPressed (new KeyEvent (DUMMY, 0, currentTimeMillis (), 0, VK_9));
    ...
    assertTrue (PlayerControl.ABS_NORTH.isButtonTwo ());
    assertTrue (PlayerControl.ABS_EAST.isButtonTwo ());
    assertTrue (PlayerControl.ABS_SOUTH.isButtonTwo ());
    assertTrue (PlayerControl.ABS_WEST.isButtonTwo ());
    ...
    PlayerControl.getKeyListener ().keyReleased (new KeyEvent (DUMMY, 0, currentTimeMillis (), 0, VK_E));
    PlayerControl.getKeyListener ().keyReleased (new KeyEvent (DUMMY, 0, currentTimeMillis (), 0, VK_Z));
    PlayerControl.getKeyListener ().keyReleased (new KeyEvent (DUMMY, 0, currentTimeMillis (), 0, VK_O));
    PlayerControl.getKeyListener ().keyReleased (new KeyEvent (DUMMY, 0, currentTimeMillis (), 0, VK_9));
    PlayerControl.getKeyListener ().keyReleased (new KeyEvent (DUMMY, 0, currentTimeMillis (), 0, VK_COMMA));
    PlayerControl.takeFrame ();
  }

  @Test
  public void testRelativePlayerBtn2 ()
  {
    // GENERATE INPUT, UPDATE THE INTERFACE AND TEST
    PlayerControl.getKeyListener ().keyPressed (new KeyEvent (DUMMY, 0, currentTimeMillis (), 0, VK_E));
    PlayerControl.getKeyListener ().keyPressed (new KeyEvent (DUMMY, 0, currentTimeMillis (), 0, VK_Z));
    ...
    assertTrue (PlayerControl.REL_NORTH.isButtonTwo ());
    assertTrue (PlayerControl.REL_EAST.isButtonTwo ());
    assertTrue (PlayerControl.REL_SOUTH.isButtonTwo ());
    assertTrue (PlayerControl.REL_WEST.isButtonTwo ());
