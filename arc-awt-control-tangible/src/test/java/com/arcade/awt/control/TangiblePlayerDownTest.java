...
public class TangiblePlayerDownTest
{
  private static final Component DUMMY  = new Component ()
  {
  };
  @Test
  public void testAbsolutePlayerDown ()
  {
    ...
    PlayerControl.getKeyListener ().keyPressed (new KeyEvent (DUMMY, 0, currentTimeMillis (), 0, VK_K));
    ...
    assertTrue (PlayerControl.ABS_NORTH.isDown ());
    assertTrue (PlayerControl.ABS_EAST.isDown ());
    assertTrue (PlayerControl.ABS_SOUTH.isDown ());
    assertTrue (PlayerControl.ABS_WEST.isDown ());
    ...
    PlayerControl.getKeyListener ().keyReleased (new KeyEvent (DUMMY, 0, currentTimeMillis (), 0, VK_K));
  ...
  @Test
  public void testRelativePlayerDown ()
  {
    // GENERATE INPUT, UPDATE THE INTERFACE AND TEST
    ...
    assertTrue (PlayerControl.REL_NORTH.isDown ());
    assertTrue (PlayerControl.REL_EAST.isDown ());
    assertTrue (PlayerControl.REL_SOUTH.isDown ());
    assertTrue (PlayerControl.REL_WEST.isDown ());
